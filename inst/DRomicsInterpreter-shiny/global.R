...
helplabel1step1 <- "The DRomics output file must be a .txt file with tabs or spaces as field separators, dots as decimal separators and NA as missing values. The first line must contain the columns names provided by the DRomics."
