                            ...
                            fixedRow(
                              column(5, offset = 1,
                                     ...
                                     p("The DRomicsInterpreter-shiny application runs on the ",
                                       ...
                                       a("GitLab", title = "GitLab", href = "https://gitlab.in2p3.fr/drgarden/DRomics", TARGET="_blank", style="color:#f28d0f;"),
                                     ...
                                     p("Issues can be reported on",
                                       a("https://gitlab.in2p3.fr/drgarden/DRomics/-/work_items", title = "https://gitlab.in2p3.fr/drgarden/DRomics/-/work_items", href = "https://gitlab.in2p3.fr/drgarden/DRomics/-/work_items", TARGET = "_blank", style="color:#f28d0f;"), ".")
                              ),
