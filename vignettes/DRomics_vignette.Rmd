...
Use `dose_log_transfo = FALSE` to use the raw scale of doses (see ?drcfit for details and examples).
...
curvesplot(r$res, addBMD = TRUE, xmax = max(tested.doses), colorby = "trend",
...
curvesplot(extendedres, facetby = "path_class", scaling = TRUE, npoints = 100,
           colorby = "trend", xmin = 0, xmax = 6.5, addBMD = TRUE) 
```
