...
**To check the assumption of the Gaussian error model**, two types of residual plots can
...
$$BMR = y_0 \pm z \times SD$$ with $y_0$ the level at the control given by the dose-response fitted model and $SD$ the residual standard deviation of the dose-response fitted model. 
...
the **use of the scaling option of each dose-reponse curve is interesting here**. 
