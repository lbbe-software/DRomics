...
selected in the dose-response modeling workflow is too high, it may be useful
...
(to select the most sensitive groups). The selectgroups() function can be used for this purpose as in the example below (see ?selectgroups for details).
