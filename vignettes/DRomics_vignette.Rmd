...
minus infinity in a log scale. It is possible to enlarge the default 
arbitrary space between the y-axis
(so the points at control) and the points at the first non null doses by fixing the limits of the x-axis as below :

```{r}
plot(f) + scale_x_log10(limits = c(0.2, 10))
```
