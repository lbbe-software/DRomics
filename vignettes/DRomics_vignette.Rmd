...
<!-- Ajout d'un exemple avec linear et diag de Venn comparant les deux (package à suggérer) (ML) -->
...
<!-- Ajout d'un exemple avec médiane et IQR (ML) -->
...
psens <- sensitivityplot(extendedres, BMDtype = "zSD",
                         group = "path_class",
                         BMDsummary = "first.quartile")
psens + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
    geom_text(aes(label = paste("   ", psens$data$groupby, "   ")),  size = 3, hjust = "inward")
```
